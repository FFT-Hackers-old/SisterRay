...
void initBattleCommandViewWidget(const MenuInitEvent* event) {
    ...
    auto battleCommandView = createCommandViewWidget(BATTLE_COMMAND_WIDGET_NAME, 0x90, 0x154, &battleCommandNameViewUpdater, BATTLE_MENU_NAME.c_str(), BATTLE_CMD_STATE);
